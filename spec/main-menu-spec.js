  ...
  attachment: {
    ...
    payload: {
      ...
      elements: [{
        ...
        image_url: 'https://github.com/CodeGeekLuke/ThomTexSpaceBot/blob/master/assets/images/apod.png',
        buttons: [{
          title: 'Show',
          type: 'postback',
          payload: 'SHOW_APOD'
        ...
        image_url: 'https://github.com/CodeGeekLuke/ThomTexSpaceBot/blob/master/assets/images/rovers.png',
        buttons: [{
          title: 'Curiosity',
          type: 'postback',
        ...
        image_url: 'https://github.com/CodeGeekLuke/ThomTexSpaceBot/blob/master/assets/images/iss.png',
        buttons: [{
        ...
        image_url: 'https://github.com/CodeGeekLuke/ThomTexSpaceBot/blob/master/assets/images/astronaut.png',
        buttons: [{
          title: 'Show',
          type: 'postback',
        ...
        image_url: 'https://github.com/CodeGeekLuke/ThomTexSpaceBot/blob/master/assets/images/about.png',
        buttons: [{
          title: 'About the bot',
          type: 'postback',
          payload: 'ABOUT'
          ...
          type: 'web_url',
          url: 'https://github.com/CodeGeekLuke/ThomTexSpaceBot/issues'
        }]
      }]
    }
  }
